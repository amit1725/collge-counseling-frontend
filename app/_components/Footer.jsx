    ...
    return (
      <footer className="bg-gray-100 text-gray-700 p-10">
        <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Services Section - Takes 50% width */}
          <nav className="md:col-span-2 flex flex-col items-center md:items-start text-center md:text-left">
          ...
          {/* Company Section - Takes 25% width */}
          <nav className="md:col-span-1 flex flex-col items-center md:items-start text-center md:text-left">
          ...
          {/* Social Media Section - Takes 25% width */}
          <nav className="md:col-span-1 flex flex-col items-center md:items-start text-center md:text-left">
