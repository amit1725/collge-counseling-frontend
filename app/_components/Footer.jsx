  ...
  return (
    <footer className="bg-gray-100 text-gray-700 p-10">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        {/* Social Media Section - 50% width & Horizontally Centered */}
        <nav className="md:col-span-2 mx-auto flex flex-col items-center text-center">
